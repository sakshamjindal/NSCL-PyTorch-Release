...
parser.add_argument('--data_vocab_json', type='checked_file', metavar='FILE')
parser.add_argument('--data_scenes_json', type='checked_file', metavar='FILE')
parser.add_argument('--data_questions_json', type='checked_file', metavar='FILE', nargs='+')
...
# misc
parser.add_argument('--use_gpu', type='bool', default=True, metavar='B', help='use GPU or not')
